...
class TemperatureMachine(StateMachine):
    ...
    def processTempStateButton(self):
        ...
        ## Cycles through thermostat states
        self.send("cycle")
        self.updateLights()
    ##
    ...
    def processTempIncButton(self):
        ...
        ## Increases the temperature setPoint and updates LEDs
        self.setPoint += 1
        self.updateLights()
    ...
    def processTempDecButton(self):
        ...
        ## Decreases the temperature setPoint and updates LEDs
        self.setPoint -= 1
        self.updateLights()
    ...
    def updateLights(self):
        ...
        # Determine visual identifiers based on setPoint and current temp (LED behavior)
    ...
    def setupSerialOutput(self):
        ...
        ## Creates a string to output state, temperature in fahrenheit, and setPoint to server
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                ## Sets Line 2 of display to current temperature
                lcd_line_2 = f"Temp: {self.getFahrenheit():0.1f}F"
    
                altCounter = altCounter + 1
            else:

                ## Sets alternative Line 2 of the display, shows current state and setPoint
                lcd_line_2 = f"Mode:{self.current_state.id} SP:{self.setPoint}F"
            ...
            if((counter % 30) == 0):
                try:
                    ## Encodes and sends current state information to server
                    output_data = self.setupSerialOutput().encode()
